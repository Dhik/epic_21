...
<div class="container" data-aos="fade-up">
	<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
		<div class="col-xl-7 col-lg-8">
			<h1 class="comp_title_li">RESEARCH MINDEDNESS</h1>
			<h2></h2>
		</div>
    </div>
</div>
...
<div class="container" data-aos="fade-up">
	<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
		<div class="col-xl-10 col-lg-8">
			<p class="desc_comp">&emsp;&emsp; Research Mindedness is a research competition initiated by the Communication Science Study Program at Padjadjaran University. This Competition combines research skills, creative solutions, and strategic planning to find breakthroughs in solving nation problems through various communication perspectives. The outcomes of this competition are research report, infographics, and creative videos that present potential research data which is then packaged creatively through digital media.</p>
			<p class="desc_comp">&emsp;&emsp; Research Mindedness will carry out a series of activities including seminars, competitions, and also company visits so that participants can have a broader picture and scope in carrying out an in-depth study of the problem. The Research Mindedness is expected to sharpen creativity and come up with innovative ideas and provide solutions to existing problems. This competition is also expected to increase and improve the skills of the 2021 Research Mindedness participants in researching a certain issue critically, systematically, and scientifically to produce a useful communication strategy.</p>
		</div>
    </div>
</div>
</section>
	...
	<div class="container pr-ex-center" data-aos="fade-up">
		<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
			...
			<div class="frame_comp">
				<iframe style="border:0; padding: 15px; margin-top: 30px; width: 100%; height: 360px" src="https://www.youtube.com/embed/NWeofPZbdrI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
		</div>
</section>
